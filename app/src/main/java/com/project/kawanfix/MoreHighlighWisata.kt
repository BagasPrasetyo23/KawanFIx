...
class MoreHighlighWisata : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_more_highligh_wisata)
        ...
        recyclerView = findViewById(R.id.recyclerviewhighlighwisata)
