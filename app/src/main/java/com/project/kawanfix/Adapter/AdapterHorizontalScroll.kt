...
class AdapterHorizontalScroll(private val array: ArrayList<data_model>):
    RecyclerView.Adapter<AdapterHorizontalScroll.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.model_wiku,parent,false)
