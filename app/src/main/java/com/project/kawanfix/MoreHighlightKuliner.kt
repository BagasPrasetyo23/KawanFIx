...
class MoreHighlightKuliner : AppCompatActivity() {
    private lateinit var adapter: AdapterVertical
    private lateinit var recyclerView: RecyclerView
    private lateinit var newArrayList: ArrayList<data_model>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_more_highlight_kuliner)
        ...
        dataInitialize()
//      rdataInitializekuliner()
        val layoutManager = GridLayoutManager(this, 2)
        recyclerView = findViewById(R.id.recyclerviewhighlighkuliner)
        recyclerView.layoutManager = layoutManager
        recyclerView.setHasFixedSize(true)
        adapter = AdapterVertical(newArrayList)
        recyclerView.adapter = adapter
    }

    private fun dataInitialize() {
        newArrayList = arrayListOf<data_model>()
